        ...
        bindEvent: function() {
            ...
            function popupArea(e) {
                ...
                _self.gearArea.className = "gearArea";
                 var areastr= '<div class="area_ctrl slideInUp">' +
                    '<div class="area_btn_box">' +
                    '<div class="area_btn larea_cancel">取消</div>' +
                    '<div class="area_btn larea_finish">确定</div>' +
                    '</div>';
               if(_self.ntag=='1'){
                   areastr+='<div  id="allpany">清除筛选条件</div>';
               }
                areastr+='<div class="area_roll_mask">' +
                    '<div class="area_roll">' +
                    '<div>' +
            ...
            /*
                _self.gearArea.innerHTML = '<div class="area_ctrl slideInUp">' +
                    ...
                    '</div>' +
                    '</div>';*/
                _self.gearArea.innerHTML =areastr;
                ...
                if(_self.ntag=='1'){
                    var larea_allpany = _self.gearArea.querySelector("#allpany");
                    larea_allpany.addEventListener('touchstart', function(e) {//所有用户
                        //_self.trigger.innerHTML ="所有用户";
...
/*				 var area_province = _self.gearArea.querySelector(".area_province");
				 ...
				 $(".area_province").find("div").eq($(".area_province").attr("val")).css({"color":"#1fb4ae"});*/
				// alert(area_province.getAttribute("val"));
				//document.getElementById("div1").innerHTML(area_province.getAttribute("val"));
            }
            //控制插件滚动后停留的值
            ...
            var countyCode = area_county.childNodes[countyVal].getAttribute('ref');
             ...
             if(_self.dom1==1){
                 if(countyText){//结果输出
                    ...
                    //_self.trigger.innerHTML =countyText;
                    //document.getElementById("now_company_id").value=countyCode;
                    //changecompany();
                }
            }else if(_self.dom1==2){
                
                
               // var str=provinceText.substr(0,4)+"-"+cityText.substr(0,2)+"-"+countyText.substr(0,2);
               // _self.trigger.innerHTML=str;
                //document.getElementById("now_company_id").value=countyCode;
                _self.trigger.value=provinceText+' '+cityText;
                document.getElementById("province").value=provinceText;
                document.getElementById("city").value=cityText;
                
            }else if(_self.dom1==3){
                var str=cityText;
                _self.valueTo.value=cityText;
                submits();
            }
